function getname(){
    ...
    if(gender === "Male"){
        document.getElementById("results").innerHTML = "You were born on " + dayOfWeek[dayOfBirth]+" and your name is " +  maleName[dayOfBirth];
        
    }else if(gender === "Female")
        document.getElementById("results").innerHTML = "You were born on " + dayOfWeek[dayOfBirth]+" and your name is " +  femaleName[dayOfBirth];
